function validation(){
	...
	if(input_text.value == "sahithi" && input_password.value == "sahithi"){
        window.location.href = url('../home/home.html');
	}
    else if(input_text.value.length <= 3 || input_password.value.length <= 3 ){
